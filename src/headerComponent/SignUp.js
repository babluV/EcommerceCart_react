  ...
  return (
    <div className='container'>
      ...
      <div className='inputStyl'>
       ...
       <input type={'text'} placeholder="Name.." value={name} autoComplete="new-password" onChange={(e)=>setName(e.target.value)}></input><br/>
       <br/>
       <input type={'email'} placeholder="Write Email Id.." autoComplete="new-password" value={email} onChange={(e)=>setEmail(e.target.value)}></input><br/>
       <br/>
